...
if handles.currentFrameBool.Value
    image1=imshow(imread(player.portrait),'InitialMagnification','fit','Parent',handles.pPic);
    image2=imshow(imread(enemy.portrait),'InitialMagnification','fit','Parent',handles.ePic);
else
