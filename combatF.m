...
if miss>=hit
    ...
    if handles.eHealthSlider.Value<=0
        ...
        newHealth=0.75*(player.hmax-handles.pHealthSlider.Value);
        ...
        switch pCharacter
            case 1
                ...
                knight.health=handles.pHealthSlider.Value+newHealth;
            ...
            case 2
                ...
                sorcerer.health=handles.pHealthSlider.Value+newHealth;                
            ...
            case 3
                ...
                thief.health=handles.pHealthSlider.Value+newHealth;
