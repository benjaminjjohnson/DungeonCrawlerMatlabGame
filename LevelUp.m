...
switch pCharacter
    case 1
        ...
        knight.strength=knight.strength+0.4;
    ...
    case 2
        ...
        sorcerer.strength=sorcerer.strength+0.4;
    ...
    case 3
        ...
        thief.strength=thief.strength+0.4;
...
switch pCharacter
    ...
    case 2
        ...
        variables=fields(sorcerer);
        sorcerer=sorcerer.(variables{1});
        sorcerer.dodge=sorcerer.dodge+2;
        sorcerer.hmax=sorcerer.hmax+2;
        sorcerer.health=sorcerer.health+2;
        sorcerer.level=sorcerer.level+1;
        save('sorcererStats','sorcerer');
...
switch pCharacter
    case 1
        ...
        variables=fields(knight);
        knight=knight.(variables{1});
        knight.accuracy=knight.accuracy+2;
        knight.hmax=knight.hmax+2;
        knight.health=knight.health+2;
    ...
    case 2
        ...
        variables=fields(sorcerer);
        sorcerer=sorcerer.(variables{1});
        sorcerer.accuracy=sorcerer.accuracy+2;
        sorcerer.hmax=sorcerer.hmax+2;
        sorcerer.health=sorcerer.health+2;
    ...
    case 3
        ...
        variables=fields(thief);
        thief=thief.(variables{1});
        thief.accuracy=thief.accuracy+2;
        thief.hmax=thief.hmax+2;
        thief.health=thief.health+2;
...
switch pCharacter
    ...
    case 2
        ...
        variables=fields(sorcerer);
        sorcerer=sorcerer.(variables{1});
        sorcerer.armor=sorcerer.armor-0.1;
        sorcerer.hmax=sorcerer.hmax+2;
        sorcerer.health=sorcerer.health+2;
        sorcerer.level=sorcerer.level+1;
        save('sorcererStats','sorcerer');
